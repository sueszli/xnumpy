...
# CHECK-NEXT:   %offset_pointer_2 = arith.index_cast {{.*}} : index to i64
...
# CHECK-NEXT:   %offset_pointer_6 = arith.index_cast %scaled_pointer_offset : index to i64
...
# CHECK-NEXT:   %offset_pointer_10 = arith.index_cast %scaled_pointer_offset_1 : index to i64
...
# CHECK-NEXT:   {{.*}} = llvm.mul {{.*}}, {{.*}} : i64
# CHECK-NEXT:   {{.*}} = arith.index_cast {{.*}} : i64 to index
# CHECK-NEXT:   %offset_pointer_14 = arith.index_cast {{.*}} : index to i64
