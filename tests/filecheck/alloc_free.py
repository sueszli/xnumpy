...
# CHECK-NEXT: ^bb1:
# CHECK-NEXT:   %offset_pointer_1 = "llvm.call"(%2) <{callee = @malloc, fastmathFlags = #llvm.fastmath<none>, CConv = #llvm.cconv<ccc>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, TailCallKind = #llvm.tailcallkind<none>}> : (i64) -> !llvm.ptr
...
# CHECK-NEXT:   %7 = arith.index_cast %1 : i64 to index
...
# CHECK-NEXT:   %scaled_pointer_offset_2 = arith.muli %7, %bytes_per_element_2 : index
...
# CHECK-NEXT:   %8 = "llvm.load"(%offset_pointer_13) <{ordering = 0 : i64}> : (!llvm.ptr) -> f32
# CHECK-NEXT:   %bytes_per_element_3 = arith.constant 4 : index
# CHECK-NEXT:   %scaled_pointer_offset_3 = arith.muli %5, %bytes_per_element_3 : index
...
# CHECK-NEXT:   "llvm.store"(%8, %offset_pointer_17) <{ordering = 0 : i64}> : (f32, !llvm.ptr) -> ()
...
# CHECK-NEXT:   %9 = arith.addi %3, %2 : i64
# CHECK-NEXT:   cf.br ^bb0(%9 : i64)
# CHECK-NEXT: ^bb2:
