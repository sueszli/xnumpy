...
def _emit_op(op: Operation, builder: ir.IRBuilder, block_map: BlockMap, phi_map: PhiMap, val_map: ValMap) -> None:
    match op:
        # constant ops (arith from index arithmetic in passes; llvm from IRGen)
        ...
        case arith.CmpiOp():
            # generated by ConvertScfToCf for loop exit conditions
        ...
        # llvm extension ops not handled by xdsl's convert_op
        case FNegOp():
